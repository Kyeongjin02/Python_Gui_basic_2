...
def add_file():
    files = filedialog.askopenfilenames(title="이미지 파일을 선택하세요", \
        ...
        initialdir=r"C:\Users\김경진\Desktop\python") 
...
def merge_image():
    ...
    for index, img in enumerate(images):
        ...
        progress = (index + 1)/len(images)*100 # 실제 percent 정보를 계산
        p_var.set(progress)
        progress_bar.update()
    
    dest_path = os.path.join(txt_dest_path.get(), "Kgj_photo.jpg")
